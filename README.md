...
Note: sometimes datasets can be quite large. If you want to store your data externally, we recommend symlinking your data directory (that is `easydata2_demo/data`) to somewhere with more room.
...
* Put any scripts or other code in the `easydata` module. We suggest you create a directory using the same initials you put in your notebook titles (e.g. `easydata/xyz`) You will be able to import it into your notebooks via `from easydata.xyz import ...`.
...
* `setup.py`
    * Turns contents of `easydata` into a
    pip-installable python module  (`pip install -e .`) so it can be
    imported in python code.
* `easydata`
    * Source code for use in this project.
    * `easydata/__init__.py`
        * Makes `easydata` a Python module.
    * `easydata/data`
